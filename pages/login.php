                ...
                <div class="p-5">
                  ...
                  <div class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="acc" placeholder="Enter Account...">
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-primary btn-user btn-block" id="loginBtn" onclick="login()">login</button>
                    <hr>
